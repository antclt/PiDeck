...
- [English CHANGELOG](https://github.com/pideck-app/PiDeck/blob/main/CHANGELOG.md)
- [中文更新日志](https://github.com/pideck-app/PiDeck/blob/main/CHANGELOG.zh-CN.md)

## Latest Release

See the [GitHub Releases](https://github.com/pideck-app/PiDeck/releases) page for the latest version and download links.
