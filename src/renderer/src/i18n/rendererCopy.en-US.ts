...
export const enUS: Record<TranslationKey, string> = {
  ...
  // Workspace card (tasks / subagents / edited files segmented bar)
  "sessionWidgets.tasksTab": "Todos",
  "sessionWidgets.subagentsTab": "Subagents",
  "sessionWidgets.filesTab": "Edited Files",
  "sessionWidgets.runningIndicator": "Subagent running",
