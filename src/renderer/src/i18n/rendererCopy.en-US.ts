...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.enablePiProxyDesc": "When on, all pi sessions use the address below by default (takes effect after restarting the session). Save the address without enabling it to apply it per-session via the \u201CSession proxy\u201D context menu item",
