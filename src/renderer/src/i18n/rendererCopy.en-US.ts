...
export const enUS: Record<TranslationKey, string> = {
  ...
  "config.dsh.modelsHint": "Provider routes: each provider under llm-pi-ai is one config card; llm-deepseek is the official DeepSeek route.",
  ...
  "config.dsh.presetsHint": "Agent presets decide a session's plugin composition (tools/skills/plan mode). New DSH sessions follow agent-presets.default in settings.yaml; the marked entry is the current default.",
