...
"config.proxyUrlUnset": "No proxy URL configured",
  ...
  "settings.catalogSectionDesc": "The built-in model catalog ships with each release (packaged resource). When new models land, the app tracks the @earendil-works/pi-ai npm latest version and pulls only the needed model-spec data (not the whole package); the overlay lives only in the app data directory and can be reverted anytime.",
...
"settings.piProxyModelsNoModelHint": "Add models via Pi Manager → Models to configure proxy for them",
  ...
  "announcements.viewOnline": "View all announcements",
