...
export const enUS: Record<TranslationKey, string> = {
  ...
  "config.dsh.orphans": "{count} foreign DSH sessions (created by other tools such as dsh-web; import them into PiDeck to use)",
  ...
  "config.dsh.foreignSessionsHint":
    "Sessions created in DSH_HOME by other tools (dsh-web, etc.) are auto-imported into the sidebar when the host starts (the target project is matched by directory; sessions without a directory go to the \"External sessions\" project). Only unmapped sessions are listed here — import them individually or all at once; imported ones disappear from this list and are never imported twice.",
  "config.dsh.importSession": "Import",
  "config.dsh.imported": "Foreign DSH session imported.",
  "config.dsh.syncAll": "Import all",
  "config.dsh.synced": "Imported {count} foreign session(s).",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.tabs.dsh": "DSH",
  "settings.dsh.statusTitle": "DSH backend status",
  "settings.dsh.statusDesc": "DSH_HOME: {home}",
  "settings.dsh.statusDescUnknown": "DSH_HOME not resolved",
  "settings.dsh.started": "Started",
  "settings.dsh.notStarted": "Not started (auto-starts on the first DSH session)",
  "settings.dsh.homeDir": "DSH data directory (DSH_HOME)",
  "settings.dsh.homeDirDesc": "Defaults to ~/.dsh (shared with the dsh CLI); leave empty for auto. Restart the host after switching. Full model/preset/plugin configuration lives in the Config dialog DSH section.",
  "settings.dsh.homeDirPlaceholder": "Empty = auto (~/.dsh first)",
  ...
  "settings.dsh.autoImportForeignDesc": "When the DSH host starts, sessions created in DSH_HOME by other tools (dsh-web, etc.) are imported into the sidebar automatically (project matched by directory; sessions without a directory go to the \"External sessions\" project; already imported are skipped). Turn this off to import them manually from the config page.",
