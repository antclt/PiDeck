...
export const enUS: Record<TranslationKey, string> = {
  ...
  "config.usageProbe.aiAssistTitle": "Copy the prompt and paste it to pi — the AI will fill this in for you",
  "config.usageProbe.aiAssistDone": "Usage skill installed and the prompt copied to clipboard; paste it to pi and send",
  "config.usageProbe.aiAssistCopiedOnly": "Prompt copied to clipboard; paste it to pi and send",
  "config.usageProbe.aiPrompt": "Please help me add a usage query config for this provider (PiDeck Settings → Configuration → Models → Usage query):\nProvider name:\nBase URL:\nUsage/balance API docs link (optional):",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "config.modelResetAdaptiveCleared": "Cleared capability fields (no adaptive template matched)",
  ...
  "settings.useOfficialBeuiDesc": "Use official beUI components (off = PiDeck-customized variants). For comparing official vs customized look/behavior: file-diff, message-scroller, todo-list, tool-result, action-swap.",
  "settings.useOfficialBeui": "Use official beUI components",
