...
"config.emptyExtensions": "No installed extensions.",
  ...
  "config.modelCapabilityTitle": "Resolved model capabilities",
  "config.modelCapabilityMatched": "Matched {model}",
  "config.modelCapabilityNotMatched": "No known model matched",
  "config.modelCapabilityNoTemplate": "No adaptive template",
  "config.modelCapabilitySourceCatalog": "Built-in catalog",
  "config.modelCapabilityMatchAlias": "Name match",
  "config.modelCapabilityMatchExact": "Exact match",
  "config.modelCapabilitySupported": "Supported",
  "config.modelCapabilityUnsupported": "Not supported",
  "config.modelCapabilityUnknown": "Not reported",
  "config.modelCapabilityMappedLevels": "Mapped levels",
  "config.modelResetAdaptive": "Reset to adaptive",
  "config.modelResetting": "Resetting…",
