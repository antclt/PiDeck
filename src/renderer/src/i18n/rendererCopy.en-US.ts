...
"settings.piProxyModelsNoModelHint": "Add models via Pi Manager → Models to configure proxy for them",
  ...
  "automation.cronHelp": "5-field standard format (min hour day month dow), e.g. 0 9 * * 1-5",
  "automation.cronPreview": "Next Trigger",
  "automation.cronInvalid": "Invalid Cron expression",
  "automation.cronPreset.daily9am": "Weekdays at 9:00 AM (0 9 * * 1-5)",
  "automation.cronPreset.hourly": "Every hour at minute 0 (0 * * * *)",
  "automation.cronPreset.every30m": "Every 30 minutes (*/30 * * * *)",
  "automation.cronPreset.midnight": "Every midnight (0 0 * * *)",
