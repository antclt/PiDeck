...
export const enUS: Record<TranslationKey, string> = {
  ...
  "rewind.openTitle": "Session checkpoints (auto-snapshotted after write/edit/bash)",
  "rewind.panelHint": "File snapshots of the current session",
  "rewind.showMore": "{count} more — show all",
  ...
  "dsh.runtime.importLocal": "Import from local file",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "feedback.ai.hint": "Generate a prompt containing the diagnostic report, then paste it to any AI (ChatGPT / DeepSeek / peers) to help locate the issue.",
