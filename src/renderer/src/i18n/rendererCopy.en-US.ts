...
export const enUS: Record<TranslationKey, string> = {
  ...
  "dshTools.open": "DSH tools (goals / subagents)",
  "codex.emptyDesc":
  ...
  "config.dsh.foreignSessionsEmpty": "No foreign sessions.",
  "config.dsh.foreignSessionsHint":
    "Sessions created in DSH_HOME by other tools (dsh-web, etc.) that PiDeck has not mapped yet. Import them to view, load history, and continue the conversation from the sidebar (the target project is matched by directory automatically).",
  ...
  "config.dsh.staticPluginsHint": "Loader entries in the current deployment cordis composition (moduleName/enabled/fiberPhase). Adding/removing or enabling static plugins is out of scope here (cordis.yml write-back would bake patch rows); edit via the Raw File tab.",
