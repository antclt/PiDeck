...
export const zhCN = {
  ...
  "rewind.title": "检查点",
  "rewind.openTitle": "查看会话检查点（write/edit/bash 操作后自动快照）",
  "rewind.panelHint": "当前会话的文件快照",
  "rewind.showMore": "还有 {count} 个，显示全部",
  ...
  "dsh.runtime.importLocal": "从本地文件导入",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "feedback.ai.hint": "生成一段包含诊断报告的提示词，复制后粘贴给任意 AI（ChatGPT / DeepSeek / 群友）即可帮你定位问题。",
