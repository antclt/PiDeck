...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "config.modelCapabilityTitle": "已识别模型能力",
  "config.modelCapabilityMatched": "匹配 {model}",
  "config.modelCapabilityNotMatched": "未匹配到已知模型",
  "config.modelCapabilityNoTemplate": "无自适应模板",
  "config.modelCapabilitySourceCatalog": "内置目录",
  "config.modelCapabilityMatchAlias": "按名称匹配",
  "config.modelCapabilityMatchExact": "精确匹配",
  "config.modelCapabilitySupported": "支持",
  "config.modelCapabilityUnsupported": "不支持",
  "config.modelCapabilityUnknown": "未报告",
  "config.modelCapabilityMappedLevels": "映射档位",
  "config.modelResetAdaptive": "重置为自适应",
  "config.modelResetting": "重置中…",
  "config.modelResetAdaptiveDone": "已按 {model} 的自适应模板重置能力字段",
  "config.modelResetAdaptiveCleared": "已清空能力字段（未匹配到自适应模板）",
