...
export const zhCN = {
  ...
  "app.thinkingPickerUnsupported": "当前模型未声明思考档位，无法选择思考级别",
  ...
  "config.usageProbe.aiAssistTitle": "复制提示词，粘给 pi 让 AI 帮你查文档填表",
  "config.usageProbe.aiAssistDone": "已安装用量查询技能，并把提示词复制到剪贴板；粘贴给 pi 发送即可",
  "config.usageProbe.aiAssistCopiedOnly": "已复制提示词到剪贴板；粘贴给 pi 发送即可",
  "config.usageProbe.aiPrompt": "请帮我为以下供应商添加用量查询配置（PiDeck 设置 → 配置管理 → 模型 → 用量查询）：\n供应商名称：\n接口 baseUrl：\n用量/余额接口文档链接（可选）：",
