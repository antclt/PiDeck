...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "imagegen.size": "尺寸",
  "imagegen.sizeHint": "OpenAI 用宽×高；火山方舟还支持 1K / 2K / 4K",
  "imagegen.watermark": "水印",
  "imagegen.watermarkHint": "火山方舟参数。OpenAI 官方接口不会发送此字段，避免 400",
  "imagegen.outputFormat": "格式",
  "imagegen.outputFormatHint": "火山 output_format：png / jpeg。OpenAI 官方不会发送此字段",
