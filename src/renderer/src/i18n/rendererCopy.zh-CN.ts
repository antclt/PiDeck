...
"settings.piProxyModelsNoModelHint": "去 Pi 管理 → 模型 添加模型后即可配置代理",
  ...
  "automation.cronHelp": "5 位标准格式（分 时 日 月 周），例如：0 9 * * 1-5",
  "automation.cronPreview": "下次触发时间",
  "automation.cronInvalid": "无效的 Cron 表达式",
  "automation.cronPreset.daily9am": "工作日早 9 点 (0 9 * * 1-5)",
  "automation.cronPreset.hourly": "每小时整点 (0 * * * *)",
  "automation.cronPreset.every30m": "每 30 分钟 (*/30 * * * *)",
  "automation.cronPreset.midnight": "每日零点 (0 0 * * *)",
