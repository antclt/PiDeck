...
export const zhCN = {
  ...
  "config.dsh.modelsHint": "Provider 路由：llm-pi-ai 下每个 provider 是一张配置卡；llm-deepseek 为官方 DeepSeek 路由。",
  ...
  "config.dsh.presetsHint": "Agent 预设决定会话的插件组合（工具/技能/计划模式等）。新建 DSH 会话时按 settings.yaml 的 agent-presets.default 选择；「默认」标记当前生效项。",
